// To parse this data:
//
//   import { Convert, SearchGifsRespone } from "./file";
//
//   const searchGifsRespone = Convert.toSearchGifsRespone(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsRespone {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsRespone(json: string): SearchGifsRespone {
        return cast(JSON.parse(json), r("SearchGifsRespone"));
    }

    public static searchGifsResponeToJson(value: SearchGifsRespone): string {
        return JSON.stringify(uncast(value, r("SearchGifsRespone")), null, 2);
    }
}
